              ...
              children: [
                ListView(
                  ...
                  children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              if (details.runtime != null)
                                _MetaChip(icon: Icons.schedule_rounded, label: '${details.runtime} min'),
                              if (details.releaseDate != null)
                                _MetaChip(icon: Icons.calendar_today_rounded, label: details.releaseDate!.split('-').first),
                              for (final genre in details.genres)
                                _MetaChip(label: genre.name),
                            ],
                          ),
                    ...
                    CastStrip(cast: loaded.cast, onCastTap: (member) => context.push(Routes.personDetailsPath(member.id))), // Person Detail screen: next
                    verticalSpace(responsiveSpacing(context, 8)),
                    MovieSectionCarousel(title: 'Similar', movies: loaded.similar, onMovieTap: (movie) {
                    ...
                    MovieSectionCarousel(title: 'Recommended', movies: loaded.recommendations, onMovieTap: (movie) {
                      if (movie.mediaType == 'movie') {
                        context.push(Routes.movieDetailsPath(movie.id));
                      } else if (movie.mediaType == 'tv') {
                        context.push(Routes.tvDetailsPath(movie.id));
