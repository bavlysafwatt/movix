...
class GetFavorites implements UseCase<List<LibraryItem>, NoParams> {
  const GetFavorites(this._repository);
  final LibraryRepository _repository;
  @override
  Future<Either<GenericException, List<LibraryItem>>> call(NoParams params) => _repository.getFavorites();
}